...
class Kebab:
    ...
    def usage(self):
        ...
        print("calories- total number of calories of all items on the skewer")
    ...
    def calories(self, args):
        """
        Displays total calories of food items on the skewer.
        :param args: ignored
        :return: None
        """
        try:
            if not self.skewer:
                raise SkewerException("skewer is not yet created ")
            else:
                print(str(self.skewer.calories()));
        except SkewerException as e:
            print(e)
